...

{
    ...
    {
        //menyimpan value untuk total cost apabila menggunakan buy max
        double totalcost = 0;
        //menyimpan initial money
        double totalmoney = UserDataManager.Progress.Gold;
        do {
        ...
        Debug.Log(totalcost > UserDataManager.Progress.Gold);
