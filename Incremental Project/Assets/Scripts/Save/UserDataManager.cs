...

{
    ...
    internal static bool HasResources(int index)
    {
        //bakal nge return false atau true berdasarkan panjang dari resource level
        return (UserDataManager.Progress.ResourcesLevels.Count > index);
    }
}